...
def get_main_status(server, options=None):
...
@_server.server_logging
def get_main_subordinates(server, options=None):
    """Return the subordinates registered for this main. In order to ease the
...
def switch_main(subordinate, main, main_user, main_passwd=None,
    ...
    commands = []
    params = []
    main_host, main_port = _server_utils.split_host_port(main.address,
